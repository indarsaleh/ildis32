    ...
    <div class="container position-relative h-100">
        <div class="header-text display-table h-100 z-index-1 width-100">
            <div class="display-table-cell vertical-align-middle text-center">
                ...
                <!-- start logo -->
                <?= Html::a(Html::img('@web/frontend/assets/img/logos/instansi-default.png', ['id' => 'logo']), ['/'], ['class' => 'navbar-brand width-200px sm-width-180px xs-width-150px margin-10px-bottom']); ?>
                <!-- end logo -->
        ...
        <div class="row">
            <div class="col-md-12 xs-margin-30px-bottom">
                <div class="text-center bg-white border padding-20px-lr padding-40px-tb border-radius-4 h-100">
                    ...
                    <h3 class="font-size20 margin-20px-bottom sm-margin-10px-bottom">Tentang JDIHN</h3>
    ...
    <div class="container">
		...
		<div class="col-sm-4 col-md-4 col-lg-1">
                        ...
                        <div class="col-sm-2 col-md-2 col-lg-12">
                            ...
                            <iframe width="700" height="400" src="https://www.youtube.com/embed/zaGeqPp-Lrk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </button>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-1">
                        </div>
    ...
    <div class="container">
        ...
        <div class="owl-carousel owl-theme" id="testmonials-carousel">
            <div class="testmonial-single margin-10px-top text-center">
                <p class="line-height-40 xs-line-height-35 width-65 md-width-70 sm-width-90 xs-width-100 center-col font-size22 xs-font-size18 position-relative text-extra-dark-gray">------------------------------------------------------------------------------------------------------</p>
                <h4 class="padding-35px-top xs-padding-20px-top font-size16 no-margin-bottom">---</h4>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="feature-inner2 display-table" style="color: red">
                            <div class="display-table-cell vertical-align-middle">
                                <div>
                                    ...
                                    <?= Html::a(Html::img('@web/frontend/assets/img/jdih/icon-portal.png'), Url::to('@web/dokumen', true)); ?>
                                </div>
                            </div>
                        </div>
                    </a>
