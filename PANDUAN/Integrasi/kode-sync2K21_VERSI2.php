...
WHERE document.is_publish = 1 AND document.tahun_terbit IS NOT NULL"; //query sql yang disesuaikan
...
$row_array->urlDetailPeraturan='http://alamatwebjdih/dokumen/view?id='.$row["sc_id"]; //berisi url halaman detail peraturan silahkan ganti s..........
