                ...
                'buttons' => [
                    ...
                    'action' => function ($url, $model) {
                        if ($model->is_publish == 0) {
                            return Html::a('<span class="fa fa-check-square"></span>', ['catatan-verifikasi/artikel', 'id' => $model->id], ['title' => 'Buat catatan', 'class' => 'btn btn-info btn-sm user-active', 'data' => ['confirm' => 'Ingin membuat catatan ?', 'method' => 'post', 'data-pjax' => false],]);
                        }
                    },
